...
public class Drive : MonoBehaviour
{
    ...
    private void CalculateDistance()
    {
        ...
        // Need to set y to a value - using Vector positions
        ...
        // Does not matter which way around as working out distance
        float uDistance = Vector3.Distance(fuelPos, tankPos);

        // Work out vector and use magnitude to find distance
    ...
    {
        // Cross Product calculation - Mult doesn't use itself in the calculation
